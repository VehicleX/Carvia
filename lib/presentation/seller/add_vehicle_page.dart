...
class _AddVehiclePageState extends State<AddVehiclePage> {
  ...
  void initState() {
    ...
    if (vehicle != null) {
      ...
      _uploadedImageUrls = List<String>.from(vehicle.images);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_isEditMode ? "Edit Vehicle" : "Add New Vehicle", style: GoogleFonts.outfit(fontWeight: FontWeight.bold)),
      ),
      body: Stepper(
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: _isSubmitLoading 
                       ...
                       : Text(_currentStep == 2 ? (_isEditMode ? "Update Vehicle" : "Publish Vehicle") : "Next"),
                  ),
                ),
                if (_currentStep > 0) ...[
  ...
  Future<void> _submitVehicle() async {
    ...
    if (user != null) {
      final vehicle = VehicleModel(
        id: widget.vehicle?.id ?? "", // Auto-generated by service for new vehicles
