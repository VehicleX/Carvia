...
import 'package:carvia/presentation/auth/widgets/otp_verification_modal.dart'; // Reuse OTP Modal
        ...
        showModalBottomSheet(
          ...
          builder: (context) => OtpVerificationModal(
            onVerified: (smsCode) async {
              // 3. Verify & Register
              try {
                final success = await authService.registerAndCreateUser(
                  email: email, 
                  password: password, 
                  name: name, 
                  phone: phone, 
                ...
                if (success) {
                   ...
                   if (context.mounted) Navigator.pop(context); // Close Register
                   // Navigation to Home is handled by AuthWrapper or manual push
                }
              } catch (e) {
                if (context.mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Registration Failed: $e")));
              }
            },
          ),
        );
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isLoading 
                    ...
                    : const Text("Verify Phone & Register"),
              ),
